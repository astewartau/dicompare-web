...
const FinalizeMapping = ({ onNext }) => {
    ...
    const inputOptions = [
        ...
        {
            name: 'Input Acquisition 3',
            details: { Modality: 'Ultrasound', Manufacturer: 'GE Healthcare', StudyDate: '2022-03-15' },
        },
    ];
    ...
    const referenceOptions = [
        {
            ...
            details: { Modality: 'CT', Manufacturer: 'GE Healthcare', StudyDate: '2022-01-01' },
        },
        {
            name: 'Reference Acquisition B',
            details: { Modality: 'MRI', Manufacturer: 'Siemens', StudyDate: '2022-02-15' },
        },
        {
            name: 'Reference Acquisition C',
            details: { Modality: 'Ultrasound', Manufacturer: 'Philips', StudyDate: '2022-03-10' },
        },
    ];
                            ...
                            <Card key={index} borderWidth="1px" borderRadius="md">
                                ...
                                >
                                    ...
                                    <IconButton
                                        size="sm"
                                        icon={
                                            expandedReferences[reference.name] ? (
                                                <ChevronDownIcon />
                                            ) : (
                                                <ChevronRightIcon />
                                            )
