    ...
    return (
        <Flex direction="column" height="100vh">
            ...
            <Box flex="1" overflowY="auto">
                <FinalizeMapping onValidationChange={handleValidationChange} onReportReady={handleReportReady} />
            </Box>

            {/* Bottom bar */}
            <HStack p={4} bg="white" boxShadow="md" justifyContent="flex-end">
                <Button colorScheme="teal" isDisabled={!canSubmit || !report} onClick={handleSubmit}>
                    Download Report
                </Button>
            </HStack>
        </Flex>
