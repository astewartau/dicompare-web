...
const Introduction = ({ onNext }) => (
  <Box p={8}>
    ...
    <Text fontSize="md" mb={6}>
      This module allows you to check an MRI scanning session for compliance with a selected template.
      Follow the steps below to upload files, configure settings, and review results.
    </Text>
