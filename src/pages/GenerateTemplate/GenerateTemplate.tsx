...
const GenerateTemplate: React.FC<GenerateTemplateProps> = ({}) => {
    ...
    const steps = [
        {
            title: 'Build schema',
            component: <EditTemplate setAcquisitionsData={setAcquisitionsData} setIsNextEnabled={setIsNextEnabled} />,
        },
        {
            title: 'Enter metadata',
            component: <EnterMetadata setMetadata={setMetadata} setIsNextEnabled={setIsNextEnabled} />,
        },
        {
            title: 'Download schema',
            component: <Review templateJson={templateJson} />,
        },
    ];
    ...
    return (
        <>
            ...
            <VerticalStepper steps={steps} isNextEnabled={isNextEnabled} setIsNextEnabled={setIsNextEnabled} />
        </>
    );
};
