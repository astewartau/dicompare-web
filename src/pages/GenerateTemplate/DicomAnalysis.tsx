...
import { Box, Heading, Text, Button, VStack, Progress, Input, HStack, Checkbox } from '@chakra-ui/react';
...
const DICOMAnalysis = () => {
    ...
    const handleFileUpload = (event) => {
        ...
        const dcmFiles = Array.from(files).filter((file) => file.name.endsWith('.dcm'));
        ...
        <Box p={6} maxW="container.md" mx="auto">
            ...
            {!processingComplete ? (
                    ...
                    <VStack spacing={4} align="start">
                        <HStack>
                            ...
                            <Text fontSize="sm" color="gray.600">
                                {fileCount > 0 ? `${fileCount} DICOM files selected` : 'No files selected'}
                            </Text>
                        </HStack>
                ...
                <>
                    ...
                    <Text fontSize="sm" color="gray.600" mb={4}>
                        Below are the sessions found in the uploaded DICOM files. Select the ones you wish to analyze.
                    </Text>
