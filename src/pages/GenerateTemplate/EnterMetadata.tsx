...
import { Box, Text, VStack, FormControl, FormLabel, Input, Textarea, FormHelperText } from '@chakra-ui/react';
        ...
        <Box width="100%">
            ...
            <VStack as="form" spacing={6} marginTop={8}>
                <FormControl id="template-name" isRequired>
                    ...
                    <FormHelperText fontSize="lg">Provide a name for your template.</FormHelperText>
                    <Input
                ...
                <FormControl id="template-description">
                    ...
                    <FormHelperText fontSize="lg">Describe the purpose and scope of this template.</FormHelperText>
                    <Textarea
                ...
                <FormControl id="authors" isRequired>
                    ...
                    <FormHelperText fontSize="lg">Specify the authors. Use comma to create new tags.</FormHelperText>
                    <Input
                        ref={authorsInputRef}
