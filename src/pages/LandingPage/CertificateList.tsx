...
const CertificateList = () => {
  ...
  return (
    <Box p={6}>
      <Heading as="h2" size="md" mb={4}>Public Certificates</Heading>
      <Input
            ...
            <HStack justify="space-between">
              <Box>
                <Heading as="h3" size="sm">
                  <Link href={cert.link} isExternal color="blue.500">{cert.title}  <Badge colorScheme={cert.level === "Gold" ? "yellow" : cert.level === "Silver" ? "gray" : "orange"}>
                  {cert.level}
                </Badge></Link>
                </Heading>
