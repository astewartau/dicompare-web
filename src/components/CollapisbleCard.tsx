...
const CollapsibleCard = ({ protocol, validFields }) => {
    ...
    const restoreSingleValueFromRow = (type, str) => {
        ...
        if (type === 'Range') {
            ...
            const [valueStr, tolStr] = str.replace('Value: ', '').replace(', Tolerance: ±', '|').split('|');
                            ...
                            {inputType === 'Value and Tolerance' && (
                                <HStack width="100%">
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setToleranceValue({ ...toleranceValue, value: e.target.value })
                                        }
                                        width="48%"
                                    />
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setToleranceValue({ ...toleranceValue, tolerance: e.target.value })
                                        }
                                        width="48%"
                                    />
                                </HStack>
                                                ...
                                                {row.valueType === 'Range' && (
                                                    <HStack>
                                                        <Input
                                                            ...
                                                            value={row.value?.min || ''}
                                                            onChange={(e) =>
                                                                handleTableRowChange(rowIndex, 'value', {
                                                                    ...row.value,
                                                                    min: e.target.value,
                                                                })
                                                            }
