...
import { EditableCellProps, ConstraintType, BaseDataType } from './types';
...
export const EditableCell: React.FC<EditableCellProps> = ({ cellData, editable, onChange, showDataType = false }) => {
            ...
            <VStack align="start" spacing={1}>
                ...
                {showDataType && (
                    <Text fontSize="xs" color="gray.500">
                        {cellData.dataType === 'list' && cellData.listSubType 
                            ? `${cellData.dataType} (${cellData.listSubType})`
                            : cellData.dataType === 'raw_json' 
                                ? 'Raw JSON'
                                : cellData.dataType
                        }
                    </Text>
