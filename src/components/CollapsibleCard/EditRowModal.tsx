...
const EditRowModal: React.FC<EditRowModalProps> = ({ isOpen, onClose, rowData, rowIndex, onSave }) => {
                            ...
                            <FormControl key={field}>
                                ...
                                <HStack spacing={4} mb={2}>
                                    <Select
                                        ...
                                        onChange={(e) => handleDataTypeChange(field, e.target.value as DataType)}
                                        size="sm"
                                    >
                                    ...
                                    <Select
                                        ...
                                        onChange={(e) =>
                                            handleConstraintChange(field, e.target.value as ConstraintType)
                                        }
                                        size="sm"
                                    >
